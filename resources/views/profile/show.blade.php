<x-layout>
    <div class="container-fluid p-5 bg-secondary-subtle text-center">
        <div class="row justify-content-center">
            <div class="col-12">
                <h1 class="display-1">Ciao {{Auth::user()->name}} !</h1>
            </div>
        </div>
    </div>

    <div class="container">
        <h2 class="text-xl font-semibold mb-4">Aggiorna il tuo profilo</h2>
        @if (session('success'))
        ...
        <form action="{{ route('profile.update') }}" method="POST">
            ...
            <div class="row">
                <div class="col-12 col-lg-6">
                    ...
                    <div class="pb-4">
                        <label for="password" class="form-label">Inserisci <strong>Nuova Password</strong>:</label>
                    ...
                    <div class="pb-4">
                        <label for="password_confirmation" class="form-label">Conferma <strong>Password</strong>:</label>
